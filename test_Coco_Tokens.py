...
@pytest.mark.parametrize("test_input,expected", [(0x92, "POKE"), (0xaa, "OFF"), (0xcb, "RENUM")])
def test_when_a_single_byte_token_is_supplied_return_the_coco_token_keyword(test_input, expected):
...
@pytest.mark.parametrize("test_input,expected", [(0x8d, "JOYSTK"), (0x93, "MEM"), (0x9d, "VARPTR")])
...
@pytest.mark.parametrize("test_input,expected", [(0x96, "NEW"), (0xCE, "DIR"), (0xDD, "BACKUP"), (0xE0, "DSKO$")])
def test_when_a_dos_token_is_used_return_a_dos_keyword(test_input, expected):
    actual = dos_tokeniser.convert(test_input)
    assert actual == expected


@pytest.mark.parametrize("test_input,expected", [(0x93, "MEM"), (0xA2, "CVN"), (0xA4, "LOC"), (0xA6, "MKN$")])
